    ...
    public void atualizarSimulacao() {
        ...
        while (noAtual != null) {
            ...
            if (!caminhao.podeViajar()) {
                ...
                estatisticas.adicionarLog("Caminhão " + caminhao.getId() + " atingiu o limite de viagens.");
            ...
            if (caminhao.chegouNaZona()) {
                if (caminhao.isEmViagemParaEstacao()) {
                    ...
                    estatisticas.adicionarLog("Caminhão " + caminhao.getId() + " chegou na estação central");
                    ...
                    estatisticas.adicionarLog("Caminhão " + caminhao.getId() + " programado para " + 
                            proximaZona.getNome() + " (tempo: " + tempoViagem + " min)");
                } else {
                    ...
                    if (lixoDisponivel > 0) {
                        ...
                        if (lixoColetado > 0) {
                            ...
                            if (coletou) {
                                ...
                                estatisticas.adicionarLog("Caminhão " + caminhao.getId() + " coletou " + lixoColetado + 
                                        "kg na " + zonaAtual.getNome() + ". Carga: " + 
                                        caminhao.getCargaAtual() + "/" + caminhao.getCapacidade());
                        ...
                        estatisticas.adicionarLog("Caminhão " + caminhao.getId() + " CHEIO. Voltando para estação. " +
                                "Tempo de viagem: " + tempoViagem + " min");
                    }
                }
            } else {
                ...
                estatisticas.adicionarLog("Caminhão " + caminhao.getId() + " em trânsito para " + 
                        (caminhao.isEmViagemParaEstacao() ? "Estação Central" : caminhao.getZonaAtual().getNome()) + 
                        ". Tempo restante: " + caminhao.getTempoParaChegar() + " min");
            }
        ...
        if (tempoSimulado % 50 == 0) {
            estatisticas.adicionarLog(estatisticas.gerarRelatorio());
        }
        
        if (tempoSimulado % 1440 == 0) {
            System.out.println("=== NOVO DIA == Resetando viagens dos caminhões...");
            estatisticas.adicionarLog("=== NOVO DIA == Resetando viagens dos caminhões...");
            Fila.No atual = filaCaminhoesPequenos.getHead();
            while (atual != null) {
